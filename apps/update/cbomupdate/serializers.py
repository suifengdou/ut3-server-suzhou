...
class CBOMUpdateSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ret = super(CBOMUpdateSerializer, self).to_representation(instance)
        return ret
...
class CBOMUpdateDetailsSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ret = super(CBOMUpdateDetailsSerializer, self).to_representation(instance)
        return ret
