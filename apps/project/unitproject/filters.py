...
class UnitProjectFilter(django_filters.FilterSet):
    ...
    units_version__number = django_filters.RangeFilter()
    units_version__units__nationality__name = django_filters.CharFilter(lookup_expr='icontains')
    units_version__units__unit_number = django_filters.RangeFilter()
