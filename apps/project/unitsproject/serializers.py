...
class ProductLineListProjectSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
            ret = super(ProductLineListProjectSerializer, self).to_representation(instance)
            return ret
...
class UnitProjectDetailsSerializer(serializers.ModelSerializer):
    created_time = serializers.DateTimeField(format="%Y-%m-%d %H:%M:%S", read_only=True)
    updated_time = serializers.DateTimeField(format="%Y-%m-%d %H:%M:%S", read_only=True)
    ...
    def to_representation(self, instance):
            ret = super(UnitProjectDetailsSerializer, self).to_representation(instance)
            return ret
