...
class AtomicPartsProject(models.Model):
    ORDER_STATUS = (
        (0, '已被取消'),
        (1, '等待递交'),
        (2, '等待处理'),
    ...
    class Meta:
        verbose_name = 'PROJECT-原子件工作台'
        verbose_name_plural = verbose_name
        db_table = 'project_atomicparts'

    def __str__(self):
        return self.name


class LogAtomicPartsProject(models.Model):
    object = models.ForeignKey(AtomicPartsProject, on_delete=models.CASCADE, verbose_name='对象', help_text='对象')
    ...
    class Meta:
        verbose_name = 'PROJECT-原子件工作台日志'
        verbose_name_plural = verbose_name
        db_table = 'project_atomicparts_logging'
