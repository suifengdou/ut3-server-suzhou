...
class Goods(models.Model):
    ...
    spec = models.IntegerField(default=0, verbose_name='规格', help_text='规格')
    gross_weight = models.FloatField(default=0, verbose_name='毛重', help_text='毛重')
    net_weight = models.FloatField(default=0, verbose_name='净重', help_text='净重')
    volume = models.FloatField(default=0, verbose_name='体积', help_text='体积')
    number_of_packages = models.IntegerField(default=0, verbose_name='包装箱规', help_text='包装箱规')
