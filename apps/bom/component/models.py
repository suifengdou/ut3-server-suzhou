...
class ComponentCategory(models.Model):
    ...
    component_category_id = models.CharField(max_length=50, unique=True, null=True, blank=True, verbose_name='组项类型编码', help_text='组项目类型编码')
    subunit_category = models.IntegerField(choices=CATEGORY_LIST, default=1, verbose_name='子项类别', help_text='子项类别')
...
class ComponentVersionDetails(models.Model):

    version = models.ForeignKey(ComponentVersion, on_delete=models.CASCADE, verbose_name='组项版本', help_text='组项版本')
    details = models.ForeignKey(MiddlePartsVersion, on_delete=models.CASCADE, verbose_name='中间件版本', help_text='中间件版本')
    memo = models.CharField(null=True, blank=True, max_length=160, verbose_name='备注', help_text='备注')
    created_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间', help_text='创建时间')
    updated_time = models.DateTimeField(auto_now=True, verbose_name='更新时间', help_text='更新时间')
    is_delete = models.BooleanField(default=False, verbose_name='删除标记', help_text='删除标记')
