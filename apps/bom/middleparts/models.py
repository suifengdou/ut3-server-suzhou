...
class MiddleParts(models.Model):
    ...
    code = models.CharField(max_length=90, unique=True, verbose_name='中间件编码', help_text='中间件编码')
...
class MiddlePartsVersion(models.Model):
    ...
    code = models.CharField(max_length=90, null=True, blank=True, verbose_name='版本编码', help_text='版本编码')
    ...
    Shrinkage = models.CharField(max_length=90, null=True, blank=True, verbose_name='成型收缩率', help_text='成型收缩率')
