...
from .serializers import CompanySerializer, ContactsSerializer
from .filters import CompanyFilter, ContactsFilter
...
class CompanyViewset(viewsets.ModelViewSet):
    ...
    filter_fields = ("name", "company", "tax_fil_number", "order_status", "category", "spain_invoice",
                     "special_invoice", "discount_rate", "created_time", "updated_time", "is_delete", "creator")
    ...
    def handle_upload_file(self, request, _file):
        ...
        if '.' in _file.name and _file.name.rsplit('.')[-1] in ALLOWED_EXTENSIONS:
            ...
            # 验证一下必要的核心字段是否存在
            _ret_verify_field = Company.verify_mandatory(result_columns)
