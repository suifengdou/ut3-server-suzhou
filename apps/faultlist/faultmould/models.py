...
class FaultMould(models.Model):
    ...
    object = models.ForeignKey(MouldVersion, on_delete=models.CASCADE, verbose_name='模具', help_text='模具')
    ...
    class Meta:
        verbose_name = 'FAULT-模具问题单'
        verbose_name_plural = verbose_name
        db_table = 'fault_mould'
