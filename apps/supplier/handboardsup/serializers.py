...
class HandBoardSupplierSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ret = super(HandBoardSupplierSerializer, self).to_representation(instance)
